...
FAKE_FINDINGS = [
    {
        ...
        "category": "roles_privilegios",
        "severity": "CRITICAL",
        "title": "Usuario con SUPERUSER innecesario",
        "description": "El rol 'app_user' tiene privilegios SUPERUSER sin justificación operativa.",
        ...
        "regulation_refs": [
            {
                "framework": "PCI-DSS",
                "article": "Req. 7",
                "description": "Restricción de acceso por necesidad.",
            },
            {
                "framework": "LFPDPPP",
                "article": "Art. 19",
                "description": "Medidas de seguridad técnicas.",
            },
        ],
        "table_name": None,
        "column_name": None,
    ...
    },
    {
        ...
        "category": "logging",
        "severity": "CRITICAL",
        "title": "Logging de conexiones desactivado",
        "description": "log_connections = off. No hay rastro de quién accede a la base de datos.",
        ...
        "regulation_refs": [
            {
                "framework": "PCI-DSS",
                "article": "Req. 10",
                "description": "Registro y monitoreo de accesos.",
            },
        ],
        "table_name": None,
        "column_name": None,
    ...
    {
        "id": "PII-001",
        "module": "datos_sensibles",
        "category": "pci",
        "severity": "CRITICAL",
        "title": "CVV almacenado en texto plano",
        "description": "La columna 'cvv' en la tabla 'tarjetas' contiene datos de verificación sin cifrado.",
        "evidence": "SELECT column_name FROM information_schema.columns WHERE column_name ILIKE '%cvv%';",
        "recommendation": "Eliminar la columna. PCI-DSS prohíbe almacenar CVV tras la autorización.",
        "remediation_sql": "ALTER TABLE tarjetas DROP COLUMN cvv;",
        "regulation_refs": [
            {
                "framework": "PCI-DSS",
                "article": "Req. 3.2",
                "description": "No almacenar CVV tras la autorización.",
            },
        ],
        "table_name": "tarjetas",
        "column_name": "cvv",
    ...
    },
    {
        "id": "PII-002",
        "module": "datos_sensibles",
        "category": "pii_contenido",
        "severity": "HIGH",
        "title": "Columna genérica contiene CURPs",
    ...
    },
    {
        ...
        "severity": "HIGH",
        "title": "Método trust habilitado en pg_hba",
        "description": "pg_hba.conf permite acceso sin contraseña desde rangos de IP amplios.",
    ...
    },
    {
        ...
        "category": "pii_nombre",
        "severity": "MEDIUM",
        "title": "Email accesible por roles sin necesidad",
    ...
    },
    {
        ...
        "severity": "MEDIUM",
        "title": "Extensión dblink instalada sin uso aparente",
        "description": "La extensión 'dblink' está instalada pero no se usa en ninguna función activa.",
        ...
        "regulation_refs": [
            {
                "framework": "CIS",
                "article": "Benchmark 3.2",
                "description": "Remover extensiones innecesarias.",
            },
        ],
        "table_name": None,
        "column_name": None,
