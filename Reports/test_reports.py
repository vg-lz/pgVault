...
FAKE_FINDINGS = [
    {
        ...
        "regulation_refs": [
            {"framework": "PCI-DSS", "article": "Req. 7", "description": "Restricción de acceso por necesidad."},
            {"framework": "LFPDPPP", "article": "Art. 19", "description": "Medidas de seguridad técnicas."},
        ],
    ...
    },
    {
        ...
        "regulation_refs": [
            {"framework": "PCI-DSS", "article": "Req. 3.2", "description": "No almacenar CVV tras la autorización."},
        ],
        "table_name": "tarjetas", "column_name": "cvv", "confidence_score": None,
    },
    {
        "id": "PII-002", "module": "datos_sensibles", "category": "pii_contenido",
        "severity": "HIGH", "title": "Columna genérica contiene CURPs",
    ...
    },
    {
        ...
        "severity": "HIGH", "title": "Método trust habilitado en pg_hba",
        ...
        "regulation_refs": [
            {"framework": "PCI-DSS", "article": "Req. 8", "description": "Autenticación de usuarios."},
        ],
        "table_name": None, "column_name": None, "confidence_score": None,
    },
    {
    ...
    },
    {
        ...
        "severity": "MEDIUM", "title": "Extensión dblink instalada sin uso aparente",
